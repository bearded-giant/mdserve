...
- Recursively scans and serves all `.md` and `.markdown` files, including subdirectories
- Displays a collapsible tree sidebar for navigating nested file hierarchies
